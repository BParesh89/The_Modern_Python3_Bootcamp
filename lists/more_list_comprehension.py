...
# Hint: use the in  operator to test is an element is in a list.  
...
answer = [num for num in num_list1 if num in num_list2]
print(answer)

name_list = ["Elie", "Tim", "Matt"]

answer2 = [name[-1::-1].lower() for name in name_list]
print(answer2)